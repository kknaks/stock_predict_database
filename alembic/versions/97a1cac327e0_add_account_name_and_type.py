...
def upgrade() -> None:
    ...
    op.add_column('stock_accounts', sa.Column('account_name', sa.String(length=50), nullable=False))
    op.add_column('stock_accounts', sa.Column('account_type', sa.Enum('REAL', 'PAPER', 'MOCK', name='accounttype'), nullable=False))
